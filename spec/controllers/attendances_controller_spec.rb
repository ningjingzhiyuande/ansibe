  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attendance as @attendance" do
        ...
        post :create, {:attendance => { "applicant_id" => "invalid value" }}, valid_session
        assigns(:attendance).should be_a_new(Attendance)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attendance" do
        ...
        Attendance.any_instance.should_receive(:update).with({ "applicant_id" => "1" })
        put :update, {:id => attendance.to_param, :attendance => { "applicant_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attendance as @attendance" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attendance.any_instance.stub(:save).and_return(false)
        put :update, {:id => attendance.to_param, :attendance => { "applicant_id" => "invalid value" }}, valid_session
        assigns(:attendance).should eq(attendance)
      end
